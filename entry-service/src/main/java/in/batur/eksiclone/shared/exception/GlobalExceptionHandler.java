package in.batur.eksiclone.shared.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleEntryNotFoundException(EntryNotFoundException e) {
    ...
    public ResponseEntity<Map<String, String>> handleTopicNotFoundException(TopicNotFoundException e) {
        Map<String, String> errorResponse = new HashMap<>();
        errorResponse.put("error", e.getMessage());
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
